...
// any error, so the local skills board is never affected. Runs after upstream's
// request-scoped GitHub skill sync so both external sources are represented.
router.get('/', maybeStartRequestSkillSync, (req, res, next) => {
